...
def process_utterance(
    ...
    mix_id, gain_list, sources, speakers, texts = read_sources(
...
def read_sources(row, n_src, librispeech_dir, wham_dir):
    ...
    sources_list, speakers_list, texts_list = [], [], []
    max_length = 0
    ...
    return mixture_id, gain_list, sources_list, speakers_list, texts_list
